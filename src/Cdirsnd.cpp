...
CDirSound::CDirSound(HWND hWnd) {
	...
	if (result == DS_OK) {
		...
		result = m_pDirectSoundObj->SetCooperativeLevel(m_hWindow, DSSCL_NORMAL);
		if (result != DS_OK)
			m_pDirectSoundObj = NULL;
	}
}
...
// The class can accommodate up to 100 such buffers.
///////////////////////////////////////////////////////////
